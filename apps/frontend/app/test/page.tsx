    ...
    return(
      <div className="h-screen font-mono bg-black w-full">
        ...
        <div className="w-[80%] h-5/7 p-3 flex items-center justify-between  mx-auto  ">
          ...
          <Question answeredquestions={answeredquestions} handleselectedanswers={handleselectedanswers} questionname={questions[currentquestion].question} options={questions[currentquestion].options} questionnumber={currentquestion}/>
